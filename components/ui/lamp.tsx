    ...
    return (
        <LampContainer>
            <motion.h1
                ...
                className="mt-8 bg-white py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-ml"
            >
                <h1 className="text-7xl">Events</h1>

                For the first time in the history of Pakistan, School of Mechanical and Manufacturing Engineering (SMME) brings to you the SMME Piston Cup!
    ...
    return (
        ...
        >
            <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
                ...
                <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] black-950 "></div>
            </div>
