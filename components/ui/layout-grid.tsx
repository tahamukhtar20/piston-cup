...
export const LayoutGrid = ({ cards }: { cards: Card[] }) => {
	...
	return (
		<div className="mx-auto grid h-full w-full max-w-7xl grid-cols-1 gap-4 p-8 md:grid-cols-2 md:p-10">
			{cards.map((card, i) => (
			...
			<motion.div
				...
				className={cn(
					"absolute left-0 top-0 z-10 h-full w-full bg-[#0C0A09] opacity-0",
